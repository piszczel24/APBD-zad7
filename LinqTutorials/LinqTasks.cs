...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = Emps.Where(e => e.Job == "Backend programmer").ToList();
            return result;
        }
        ...
        public static IEnumerable<Emp> Task4()
        {
            ...
            IEnumerable<Emp> result = Emps.Where(e => e.Salary == maxSalary).ToList();
            return result;
        }
        ...
        {
            IEnumerable<object> result = Emps.Join(Depts, e => e.Empno, d => d.Deptno, (e, d) => new
            {
        ...
        public static IEnumerable<object> Task7()
        {
            IEnumerable<object> result = Emps.GroupBy(e => e.Job)
                .Select(a => new { Praca = a.Key, LiczbaPracownikow = a.Count() }).ToList();
            return result;
        }
        ...
        {
            var result = Emps.Where(e => e.Job == "Frontend programmer").OrderByDescending(e => e.HireDate)
                .FirstOrDefault();
            return result;
        }
        ...
        {
            var firstQuery = Emps.Select(e => new { e.Ename, e.Job, e.HireDate });
            IEnumerable<object> result = firstQuery.Union(
        ...
        public static IEnumerable<object> Task11()
        {
            IEnumerable<object> result = Emps.GroupBy(e => e.Deptno)
                ...
                .Select(a => new
                {
                    name = Depts.FirstOrDefault(d => d.Deptno == a.Key)?.Dname,
                    numOfEmployees = a.Count()
                }).ToList();
            ;
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = Depts
                .Where(d => Emps.All(e => e.Deptno != d.Deptno) || Emps.Count(e => e.Deptno == d.Deptno) == 5)
                .OrderBy(dept => dept.Dname).ToList();
            ;
            //result =
            return result;
        }
        ...
        {
            IEnumerable<Dept> result = Emps.SelectMany(e => Depts, (e, dept) => dept).ToList();
            //result =
            return result;
        }
    }
